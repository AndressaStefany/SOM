...
timerSim2= timer;
timerSim2.BusyMode= 'drop';
timerSim2.ExecutionMode= 'fixedSpacing';
%%%%%%%%%%Change?%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
timerSim2.Name= 'CreateSim';    % To specify timer for deletion
timerSim2.ObjectVisibility= 'on';
%%%%%%%%%%Change?%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
timerSim2.Period= 0.5;
timerSim2.TasksToExecute= inf;
timerSim2.TimerFcn= {@updateSim2,obj,handles};
start(timerSim2)
...
function updateSim2(timer, event, obj, handles)
    robo= get(handles.text_title,'UserData');
    distSonar= genSonar(robo);
